...
import { NeverMissYarn } from "@/components/home/NeverMissYarn";
import { NewsletterForm } from "@/components/forms/NewsletterForm";
import { footerNavLinks, siteConfig, streamingPlatforms } from "@/data/site";
          ...
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <div className="mt-6 space-y-1">
                <a
                  ...
                  className="block text-sm text-primary-foreground/70 hover:text-white"
                >
                  {siteConfig.email}
                </a>
            ...
            <div>
              ...
              <p className="mt-4 text-sm text-primary-foreground/70">
                Weekly episode drops and exclusive content.
              </p>
              <div className="mt-4">
